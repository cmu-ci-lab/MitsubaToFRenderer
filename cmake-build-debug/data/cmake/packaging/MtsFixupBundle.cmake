...
if (APPLE)
  ...
  function (gp_resolve_item_override context item exepath dirs resolved_item_var resolved_var)
    set (dependency_dest "${CMAKE_INSTALL_PREFIX}/Mitsuba.app/Contents/Frameworks")
  ...
  function (gp_resolved_file_type_override file type_var)
    if ("${${type_var}}" STREQUAL "other")
      set (base_preffix "${CMAKE_INSTALL_PREFIX}/Mitsuba.app/Contents/Frameworks/")
...
file (GLOB MTSPLUGINS
  "${CMAKE_INSTALL_PREFIX}/Mitsuba.app/plugins/*${CMAKE_SHARED_LIBRARY_SUFFIX}")
file (GLOB_RECURSE QTPLUGINS
  "${CMAKE_INSTALL_PREFIX}/Mitsuba.app/Contents/qt4plugins/*${CMAKE_SHARED_LIBRARY_SUFFIX}")
  
# Get the python bindings as well
file (GLOB PYBINDINGS "${CMAKE_INSTALL_PREFIX}/Mitsuba.app/python/*")
...
if (NOT APPLE OR NOT BUILD_GUI)
  get_filename_component(EXEDIR "${CMAKE_INSTALL_PREFIX}/Mitsuba.app/Contents/MacOS" ABSOLUTE)
...
set (libpaths "/Users/jiatiansun/Documents/compG/mitsuba/dependencies/frameworks;/Users/jiatiansun/Documents/compG/mitsuba/dependencies/lib;/System/Library/Frameworks;/usr/lib")


# Use our custom version of fixup_bundle, which supports @rpath on OS X
list(APPEND CMAKE_MODULE_PATH "/Users/jiatiansun/Documents/compG/mitsuba/data/cmake")
