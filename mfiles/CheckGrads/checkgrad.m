function [d dy dh] = checkgrad(f, X, e, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)
...
%
% Example: checkgrad('rosenbrock', randn(3,1), 1e-5)
%
% Carl Edward Rasmussen, 2001-08-01.

argstr = [f, '(X'];                            % assemble function call strings
argstrd = [f, '(X+dx'];
% argstr = [argstr, ', varargin{:}'];
% argstrd = [argstrd, ', varargin{:}'];
for i = 1:(nargin - 3)
