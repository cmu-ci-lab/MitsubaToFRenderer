...
template bool TEllipsoid<Point3d, double>::earlyTriangleReject(const Point &a, const Point &b, const Point &c, const Normal &N, const size_t &primIdx, const AABB& triangleAABB) const;
